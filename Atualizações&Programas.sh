...
sudo apt install ubuntu-restricted-extras nodejs gimp gnome-tweaks nitrogen audacity shotcut tilix zsh fzf fonts-powerline snapd vlc rhythmbox fonts-firacode ifuse ranger tty-clock node-typescript make wget -y
